...
export const topBarZh: LocaleMessages['topBar'] = {
      ...
      officialSite: '官方网站',
      officialSiteHint: '访问暖立方官方网站',
      githubText: 'Github',
      giteeText: 'Gitee',
      githubRepo: '访问GitHub仓库',
      giteeRepo: '访问Gitee仓库',
...
export const topBarEn: LocaleMessages['topBar'] = {
      ...
      officialSiteHint: 'Visit the official NikkiCube website',
      githubText: 'GitHub',
      giteeText: 'Gitee',
      githubRepo: 'Open the GitHub repository',
      giteeRepo: 'Open the Gitee repository',
      ...
      updateLog: 'Release history',
      helpAbout: 'Help and introduction',
