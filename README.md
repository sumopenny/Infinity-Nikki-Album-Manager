...
- 搭配页顶部可直接输入搭配码并点击黄色“解析搭配码”按钮，无需先创建搭配方案；解析结果复用同一个搭配码解析窗口。
