...
describe('AboutDialog release history', () => {
  it('opens older release history and returns to about', async () => {
    ...
    expect(document.body.querySelector('.about-history-list .about-changelog-entry')?.textContent).toContain('v1.4.1')
    expect(document.body.querySelector('.about-history-list')?.textContent).toContain('v1.4')
    expect(document.body.querySelector('.about-history-list')?.textContent).toContain('v1.3.3')
