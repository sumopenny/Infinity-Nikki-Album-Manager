...
- Enter a code directly in the field at the top of the Outfit Code page and use the yellow Decode outfit code button without creating a plan first; results open in the same decoder dialog.
